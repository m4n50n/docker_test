...
# Comando que solamente se ejecutará cada vez que se INICIE el contenedor (array formado por el comando y sus argumentos -en el siguiente caso, el comando sería node /home/app/index.js)
